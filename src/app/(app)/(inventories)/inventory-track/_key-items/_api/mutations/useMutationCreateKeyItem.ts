...
// export const useMutationCreateKeyItem = () => {
//   return useMutation({
//     mutationKey: ["create-key-item"],
//     mutationFn: (body: InventoryDailyTrackSchemaType) => {
//       const payload = omitEmpty({
//         branch_id: body.branch_id.id,
//         ingredient_id: body.ingredient_id.id,
//         ingredient_unit_id: body.ingredient_unit_id.id,
...
//           out_ingredient_unit_id: item.out_ingredient_unit_id.id,
//           total_in_quantity: item.total_in_quantity,
//           total_out_quantity: item.total_out_quantity,
//         })),
//       });

//       return api.post("/daily-key-items", payload);
//     },
//   });
// };
import api from "@/lib/axios";
